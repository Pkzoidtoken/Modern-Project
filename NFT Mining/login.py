...
mycanvas = Canvas(root1, width=468, height=493, bg="grey", highlightthickness=0,bd=0)
mycanvas.pack(fill="both", expand=True)

# Load and place image as background
frame_photo = PhotoImage(file='earn.png')
frame_label = Label(root1, border=0, bg='grey', image=frame_photo)
frame_label.pack(fill="both", expand=True)

mycanvas.create_image(0, 0, image=frame_photo, anchor="nw")
